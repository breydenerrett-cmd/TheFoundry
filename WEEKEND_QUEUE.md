...
| T-02 | Add CI: GitHub Actions `cargo fmt --check`, `clippy`, `cargo test` on push/PR | P0 | R-01 | Sonnet | VERIFYING | workflow file, green run on `main` | see progress log | Workflow pushed; awaiting first Actions run. |
